      ...
      <div className="w-full max-w-md">
        <div className="bg-[#222222] rounded-2xl border border-[#444444] p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#999999] mt-2">Sign in to manage menu items</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-[#999999] mt-1">Demo: admin@cafe.com</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-[#999999] mt-1">Demo: password123</p>
            </div>
